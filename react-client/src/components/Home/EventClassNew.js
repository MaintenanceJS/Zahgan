          ...
          <div className="row">
            <div className="col-sm-6">
              ...
              <div className="row">
                ...
                <div className="col-sm-3">{this.state.items.cost}</div>
                <div
                  style={{
                    display: this.state.isLoggedIn === true ? "block" : "none"
                  }}
              ...
              <div className="row">
                ...
                <div className="col-sm-9">{this.state.items.des}</div>
              </div>
              <div className="row">
                <div className="col-sm-3">
                  <p>Event Date</p>
                </div>
                <div className="col-sm-9">{this.state.items.date}</div>
              </div>
