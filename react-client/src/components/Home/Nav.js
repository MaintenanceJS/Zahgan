      ...
      <div>
        <nav className="navbar navbar-expand-sm ">
          <ul className="navbar-nav">
            ...
            <li
              style={{
                display: this.state.isLoggedIn === false ? "block" : "none"
              }}
            >
              <a href="/SignInCreator">Manager</a>
            </li>
            <li>
              <a href="/Eventsets" onClick={this.ToEvents} id="clickEvent">
                Events
              </a>
            </li>
            <li
            ...
            <li
              style={{
                display: this.state.isLoggedIn === true ? "block" : "none"
              }}
            >
            ...
            >
              <a href="javascript:void(0);">
                Welcome {this.jsUcfirst(this.state.userName)}
              </a>
            </li>
          </ul>
        </nav>
          ...
          >
            <ModalBody>
              ...
              <h4>
                ...
                >
                  <strong>Dear Valued User,</strong> <br /> you can contact us
                  whenever you want by: <br /> Phone number: <br />
                  0791333443 <br /> Email: <br />
                  www.zahgan@gmail.com <br />
                  Fax: <br />
                  xxxxxxxxxxxx
                </p>
              </h4>
